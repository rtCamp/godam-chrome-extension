...
const Setup = () => {
                ...
                setTimeout(() => {
                    ...
                    chrome.storage.local.get(['previousTabId'], (result) => {
                        if (result.previousTabId) {
                            chrome.tabs.update(result.previousTabId, {
                                active: true,
                            })
    ...
    return (
        <div className="setupBackground">
            ...
            <div role="button" className="loginButton" onClick={LoginWithGoDAM}>
                <div className="buttonLeft">
                    <ReactSVG
                        fontSize={16}
                        src={URL + 'editor/icons/godam.svg'}
                    />
                </div>
                <div className="buttonMiddle">
                    {loading
                        ? 'Authenticating via GoDAM...'
                        : 'Login with GoDAM'}
                </div>
            </div>

            <p className="noAccount">
                Start recording your screen with GoDAM. Need an account?{' '}
                <a href="https://godam.io/pricing/" target="_blank">
