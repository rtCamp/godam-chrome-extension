    ...
    useEffect(() => {
        ...
        if (contentState.drawingMode) {
            contentState.openToast(
                chrome.i18n.getMessage('drawingModeToast'),
                () => {
                    setMode('')
                }
            )
        ...
        if (contentState.blurMode) {
            contentState.openToast(
                chrome.i18n.getMessage('blurModeToast'),
                () => {
                    setMode('')
                }
            )
                ...
                >
                    ...
                    >
                        <div className="ToolbarToggleWrap">
                            ...
                            <DrawingToolbar
                                visible={mode === 'draw' ? 'show-toolbar' : ''}
                            />
                        </div>
                        <div className="ToolbarToggleWrap">
                            <ToolTrigger
                            ...
                            <BlurToolbar
                                visible={mode === 'blur' ? 'show-toolbar' : ''}
                            />
                        </div>
                        ...
                        <div className="ToolbarToggleWrap">
                            <ToolTrigger
                                ...
                                value="cursor"
                            >
                                {contentState.cursorMode === 'target' && (
                                    <TargetCursorIcon />
                                )}
                                ...
                                {contentState.cursorMode === 'none' && (
                                    <CursorIcon />
                                )}
                            </ToolTrigger>
                            <CursorToolbar
                                visible={
                                    mode === 'cursor' ? 'show-toolbar' : ''
                                }
                                mode={mode}
                                setMode={setMode}
                            />
