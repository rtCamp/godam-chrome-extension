...
const StrokeWeight = (props) => {
    const [contentState, setContentState] =
        React.useContext(contentStateContext)
    ...
    return (
        <React.Fragment>
            <TooltipWrap
                ...
                content={
                    props.open
                        ? chrome.i18n.getMessage('thickStrokeTooltip')
                        : ''
                }
            >
                <span>
            ...
            <TooltipWrap
                ...
                content={
                    props.open
                        ? chrome.i18n.getMessage('mediumStrokeTooltip')
                        : ''
                }
            >
                <span>
            ...
            <TooltipWrap
                ...
                content={
                    props.open
                        ? chrome.i18n.getMessage('thinStrokeTooltip')
                        : ''
                }
            >
                <span>
