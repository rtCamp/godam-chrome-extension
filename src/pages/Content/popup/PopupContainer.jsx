...
const PopupContainer = (props) => {
  ...
  const updateNotice = async () => {
    ...
    if (!orgList || !Array.isArray(orgList) || orgList.length === 0) {
      ...
      orgList.filter(({ role }) => role.toLowerCase() !== 'viewer').length === 0
    ) {
            ...
            >
              {!showNotice ? (
                    ...
                    >
                      <div className='TabsTriggerIcon'>
                        <img
                          ...
                          src={tab === 'dashboard' ? GoDAMIcon : GoDAMIcon}
                        />
                      </div>
                      GoDAM
                    </Tabs.Trigger>
                ...
                >
                  {noticeMessage && (
                    <>
                      <p style={{ textAlign: 'center' }}>{noticeMessage}</p>
                  ...
                  <a
                    ...
                    target='_blank'
                  >
                    <span className='main-button-label'>{noticeBtnText}</span>
