          ...
          <div className="popup-warning-right">
            ...
            {!contentState.cameraPermission && (
                ...
                >
                    ...
                    <span>
                        {chrome.i18n.getMessage('allowCameraAccessButton')}
                    </span>
                </button>
            )}
            {contentState.cameraPermission && (
            ...
            {!contentState.microphonePermission && (
                ...
                >
                    <img src={MicOffBlue} />
                    <span>
                        {chrome.i18n.getMessage('allowMicrophoneAccessButton')}
                    </span>
                </button>
            )}
            {contentState.microphonePermission && (
            ...
            {((contentState.microphonePermission &&
                ...
                <div>
                    ...
                    <Switch
                        label={
                            isMac
                                ? chrome.i18n.getMessage('pushToTalkLabel') +
                                  ' (⌥⇧U)'
                                : chrome.i18n.getMessage('pushToTalkLabel') +
                                  ' (Alt⇧U)'
                        }
