...
import { CheckWhiteIcon, DropdownIcon } from '../../images/popup/images'
...
const GoDAMVideos = () => {
    ...
    useEffect(() => {
        ;(async () => {
            ...
            const { selectedOrg } = await chrome.storage.local.get([
                'selectedOrg',
            ])
                    ...
                    <Select.Viewport className="SelectViewport">
                        {orgList.map(({ name, role }) => (
                            <SelectItem
                                value={name}
                                key={name}
                                disabled={role.toLowerCase() === 'viewer'}
                            >
                                {name}
                            </SelectItem>
                        ))}
