...
const SettingsMenu = (props) => {
    ...
    useEffect(() => {
        ...
        if (
            chromeVersion &&
            parseInt(chromeVersion[2], 10) < MIN_CHROME_VERSION
        ) {
            setOldChrome(true)
        }
    }, [])
                    ...
                    chrome.runtime
                        ...
                        .then((response) => {
                            ...
                            const data = {
                                ...
                                defaultAudioOutput:
                                    contentState.defaultAudioOutput,
                                defaultVideoInput:
                                ...
                                askForPermissions:
                                    contentState.askForPermissions,
                                ...
                                offscreenRecording:
                                    contentState.offscreenRecording,
