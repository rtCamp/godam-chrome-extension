...
const ContentState = (props) => {
    ...
    const stopRecording = useCallback(() => {
        ...
        const audio = new Audio(
            chrome.runtime.getURL('/assets/sounds/beep.mp3')
        )
        audio.volume = 0.5
        audio.play()
    })
    ...
    const onMessage = useCallback(
        (request, sender, sendResponse) => {
            if (request.type === 'time') {
                ...
                if (!request.force) {
                    if (
                        !contentStateRef.showExtension &&
                        !contentStateRef.recording
                    ) {
        ...
        chrome.storage.local.get(
            ...
            (result) => {
                setContentState((prevContentState) => ({
                    ...prevContentState,
                    audioInput:
                        result.audioInput !== undefined &&
                        result.audioInput !== null
                            ? result.audioInput
                            : prevContentState.audioInput,
                    videoInput:
                        result.videoInput !== undefined &&
                        result.videoInput !== null
                            ? result.videoInput
                    ...
                    cameraFlipped:
                        result.cameraFlipped !== undefined &&
                        result.cameraFlipped !== null
                            ? result.cameraFlipped
                            : prevContentState.cameraFlipped,
                    cameraActive:
                        result.cameraActive !== undefined &&
                        result.cameraActive !== null
                            ? result.cameraActive
                            : prevContentState.cameraActive,
                    micActive:
                        result.micActive !== undefined &&
                        result.micActive !== null
                            ? result.micActive
                    ...
                    customRegion:
                        result.customRegion !== undefined &&
                        result.customRegion !== null
                            ? result.customRegion
                            : prevContentState.customRegion,
                    regionWidth:
                        result.regionWidth !== undefined &&
                        result.regionWidth !== null
                            ? result.regionWidth
                            : prevContentState.regionWidth,
                    regionHeight:
                        result.regionHeight !== undefined &&
                        result.regionHeight !== null
                            ? result.regionHeight
                    ...
                    hideToolbar:
                        result.hideToolbar !== undefined &&
                        result.hideToolbar !== null
                            ? result.hideToolbar
                    ...
                    alarmTime:
                        result.alarmTime !== undefined &&
                        result.alarmTime !== null
                            ? result.alarmTime
                    ...
                    cursorMode:
                        result.cursorMode !== undefined &&
                        result.cursorMode !== null
                            ? result.cursorMode
                            : prevContentState.cursorMode,
                    pushToTalk:
                        result.pushToTalk !== undefined &&
                        result.pushToTalk !== null
                            ? result.pushToTalk
                            : prevContentState.pushToTalk,
                    zoomEnabled:
                        result.zoomEnabled !== undefined &&
                        result.zoomEnabled !== null
                            ? result.zoomEnabled
                            : prevContentState.zoomEnabled,
                    askMicrophone:
                        result.askMicrophone !== undefined &&
                        result.askMicrophone !== null
                    ...
                    popupPosition:
                        result.popupPosition !== undefined &&
                        result.popupPosition !== null
                    ...
                    hideUIAlerts:
                        result.hideUIAlerts !== undefined &&
                        result.hideUIAlerts !== null
                            ? result.hideUIAlerts
                    ...
                    toolbarHover:
                        result.toolbarHover !== undefined &&
                        result.toolbarHover !== null
                            ? result.toolbarHover
                            : prevContentState.toolbarHover,
                    askDismiss:
                        result.askDismiss !== undefined &&
                        result.askDismiss !== null
                            ? result.askDismiss
                    ...
                    systemAudio:
                        result.systemAudio !== undefined &&
                        result.systemAudio !== null
                            ? result.systemAudio
                    ...
                    backupSetup:
                        result.backupSetup !== undefined &&
                        result.backupSetup !== null
                            ? result.backupSetup
                            : prevContentState.backupSetup,
                    qualityValue:
                        result.qualityValue !== undefined &&
                        result.qualityValue !== null
                            ? result.qualityValue
                            : prevContentState.qualityValue,
                    fpsValue:
                        result.fpsValue !== undefined &&
                        result.fpsValue !== null
                            ? result.fpsValue
