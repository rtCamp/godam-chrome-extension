...
*/
    ...
    function Nb(a, b, c, d, e) {
        ...
        e ||
            ...
            d && !e
                ...
                : !d &&
                  e &&
                  ((g = Array.prototype.slice.call(g)), (a.h[c] = g)))
        return g
    }
    function Ob(a, b, c) {
        var d = !!(Q(a.o) & 2)
    ...
    function $b(a, b, c, d, e, g, f) {
        if ((a = a.h && a.h[c])) {
            ...
            d & 2
                ? (d = a)
                : ((g = Ca(a, Zb)), Cb(d, g), Object.freeze(g), (d = g))
            Hb(b)
            f = null == d ? Fb : Ab([])
            if (null != d) {
                g = !!d.length
    ...
    function oc(a, b, c, d, e, g) {
        ...
        for (; f < a.length; ) {
            ...
            switch (k) {
                ...
                default:
                    throw Error(
                        'unexpected number of binary field arguments: ' + k
                    )
            }
        }
        return b
            ...
            function (a, b, c) {
                ...
                if (db) {
                    var g = a,
                        f
                    ;(f = cb) ||
                        (f = cb = new TextDecoder('utf-8', { fatal: !0 }))
                    a = e + d
        ...
        return E(function (p) {
            switch (p.h) {
                ...
                case 2:
                    ...
                    if ('object' === typeof window)
                        return (
                            bd('createMediapipeSolutionsWasm', {
        ...
        return E(function (v) {
            switch (v.h) {
                ...
                case 2:
                    ...
                    if ('texture' !== r.type)
                        throw Error(
                            "Unknown output config type: '" + r.type + "'"
                        )
                    n = a.v[m]
            ...
            options: {
                ...
                modelSelection: {
                    ...
                    graphOptionXref: {
                        ...
                        calculatorName:
                            'ConstantSidePacketCalculatorModelSelection',
                        fieldName: 'int_value',
                    },
                    onChange: function (c) {
                        var d, e, g
                        return E(function (f) {
                            if (1 == f.h)
                                return (
                                    (d = md(c)),
                                    (e =
                                        'third_party/mediapipe/modules/selfie_segmentation/' +
                                        d),
                                    D(f, gd(b.h, d), 2)
                                )
                            g = f.i
