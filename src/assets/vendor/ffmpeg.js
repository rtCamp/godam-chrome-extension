!(function (e, t) {
    ...
    (() => {
        ...
        ;(e.g = (function () {
            ...
            (() => {
                ...
                if (
                    !t &&
                    s &&
                    (s.currentScript && (t = s.currentScript.src), !t)
                ) {
        ...
        class i {
                ...
                this.#e ||
                    ((this.#e = s
                        ? new Worker(
                              new URL(
                                  s,
                                  'file:///Users/zeelprajapati/Downloads/ffmpeg.wasm/packages/ffmpeg/dist/esm/classes.js'
                              ),
                              { type: 'module' }
                          )
            ...
            exec = (e, s = -1, { signal: r } = {}) =>
                this.#i(
                    { type: t.EXEC, data: { args: e, timeout: s } },
                    void 0,
                    r
                )
            ffprobe = (e, s = -1, { signal: r } = {}) =>
                this.#i(
                    { type: t.FFPROBE, data: { args: e, timeout: s } },
                    void 0,
                    r
                )
            terminate = () => {
                ...
                for (const t of e)
                    this.#s[t](o), delete this.#s[t], delete this.#t[t]
                this.#e &&
            ...
            writeFile = (e, s, { signal: r } = {}) => {
                ...
                return (
                    ...
                    this.#i(
                        { type: t.WRITE_FILE, data: { path: e, data: s } },
                        a,
                        r
                    )
                )
            ...
            mount = (e, s, r) =>
                this.#i(
                    {
                        type: t.MOUNT,
                        data: { fsType: e, options: s, mountPoint: r },
                    },
                    []
                )
            unmount = (e) =>
